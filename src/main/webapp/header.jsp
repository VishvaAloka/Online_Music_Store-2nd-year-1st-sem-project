		  ...
		  <div class="container-fluid">
		    ...
		    <div class="collapse navbar-collapse" id="navbarSupportedContent">
		      <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
		        <li class="nav-item"> 
		          <a class="nav-link active" aria-current="page" href="http://localhost:8097/Deezer/index.jsp">Home</a>
		        </li>
		        <li class="nav-item">
		          <a class="nav-link" href="http://localhost:8097/Deezer/insertSong.jsp">Insert Song</a>
		        </li>
		        <li class="nav-item">
		          <a class="nav-link" href="http://localhost:8097/Deezer/searchSong.jsp">Search Song </a>
		        </li>
		        <li class="nav-item">
		          <a class="nav-link" href="http://localhost:8097/Deezer/Songs.jsp">New</a>
		        </li>
		         <li class="nav-item"> 
		          <a class="nav-link active" aria-current="page" href="http://localhost:8097/Deezer/Artists.jsp">Artists</a>
		        </li>
		        ...
		        <li class="nav-item dropdown">
		          ...
		          <ul class="dropdown-menu dropdown-menu-end bg-dark" aria-labelledby="navbarDropdown">
		            <li><a class="dropdown-item text-white" href="http://localhost:8097/Deezer/Admin/usercrud.jsp"><i class="bi bi-person"></i> Profile</a></li>
		            <li><a class="dropdown-item text-white" href="#"><i class="bi bi-gear"></i> Settings</a></li>
		            <li><hr class="dropdown-divider"></li>
		            <li><a class="dropdown-item text-white" href="http://localhost:8097/Deezer/Login.jsp"><i class="bi bi-box-arrow-right"></i> Logout</a></li>
		          </ul>
		        </li>
		      </ul>
		    </div>
