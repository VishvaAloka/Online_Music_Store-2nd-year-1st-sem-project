...
<br><br><br><br><br><br><br>
 <center>
<h2  style="color:white;">Delete Song </h2></center>
<div class="container">
...
<div class="container mt-5">
    <form action="deleteSong" method="post">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="song_type" value="<%= song_type %>" readonly>
        </div>
        <div class="form-group">
        ...
        <br><br>
        <button type="submit" class="btn btn-danger" name="submit">Delete Song</button>
    </form>
</div>
